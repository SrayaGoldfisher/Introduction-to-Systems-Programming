...
int main() {
	...
	//get from user number (money), Calculates the minimum amount of banknotes and coins and print
	...
	//calculate x1 x2 according to 3 numbers-a,b,c by quadratic equation
